...
const translations = {
  es: {
    ...
    quote_content: "¿Tienes el contenido (textos, fotos, logo)?",
    ...
    quote_urg_urgent: "🔥 Urgente (<1 semana)",
    quote_urg_normal: "✅ Normal (2-3 semanas)",
    quote_urg_relaxed: "🕐 Sin prisa (1 mes+)",
    quote_cont_yes: "✅ Sí, tengo todo",
    quote_cont_partial: "🔶 Tengo algo",
    quote_cont_no: "❌ No, necesito ayuda",
  ...
  en: {
    ...
    quote_content: "Do you have content ready (text, photos, logo)?",
    ...
    quote_urg_urgent: "🔥 Urgent (<1 week)", quote_urg_normal: "✅ Normal (2-3 weeks)", quote_urg_relaxed: "🕐 No rush (1 month+)",
    quote_cont_yes: "✅ Yes, I have everything", quote_cont_partial: "🔶 I have some", quote_cont_no: "❌ No, I need help",
  ...
  pt: {
    ...
    quote_content: "Você tem o conteúdo pronto (textos, fotos, logo)?",
    ...
    quote_urg_urgent: "🔥 Urgente (<1 semana)", quote_urg_normal: "✅ Normal (2-3 semanas)", quote_urg_relaxed: "🕐 Sem pressa (1 mês+)",
    quote_cont_yes: "✅ Sim, tenho tudo", quote_cont_partial: "🔶 Tenho algo", quote_cont_no: "❌ Não, preciso de ajuda",
  ...
  fr: {
    ...
    quote_content: "Avez-vous le contenu prêt (textes, photos, logo)?",
    ...
    quote_urg_urgent: "🔥 Urgent (<1 semaine)", quote_urg_normal: "✅ Normal (2-3 semaines)", quote_urg_relaxed: "🕐 Sans presse (1 mois+)",
    quote_cont_yes: "✅ Oui, j'ai tout", quote_cont_partial: "🔶 J'en ai une partie", quote_cont_no: "❌ Non, j'ai besoin d'aide",
  ...
  de: {
    ...
    quote_content: "Haben Sie den Inhalt bereit (Texte, Fotos, Logo)?",
    ...
    quote_urg_urgent: "🔥 Dringend (<1 Woche)", quote_urg_normal: "✅ Normal (2-3 Wochen)", quote_urg_relaxed: "🕐 Kein Stress (1 Monat+)",
    quote_cont_yes: "✅ Ja, ich habe alles", quote_cont_partial: "🔶 Ich habe einiges", quote_cont_no: "❌ Nein, ich brauche Hilfe",
