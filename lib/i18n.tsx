...
const translations = {
  es: {
    ...
    quote_cont_partial: "🔶 Tengo algo, falta texto/logo",
  ...
  en: {
    ...
    quote_cont_yes: "✅ Yes, I have texts and logo", quote_cont_partial: "🔶 I have some, missing text/logo", quote_cont_no: "❌ No, I need help with everything",
  ...
  pt: {
    ...
    quote_cont_yes: "✅ Sim, tenho textos e logo", quote_cont_partial: "🔶 Tenho algo, falta texto/logo", quote_cont_no: "❌ Não, preciso de ajuda com tudo",
  ...
  de: {
    ...
    quote_cont_yes: "✅ Ja, ich habe Texte und Logo", quote_cont_partial: "🔶 Ich habe einiges, fehlt Text/Logo", quote_cont_no: "❌ Nein, ich brauche Hilfe",
